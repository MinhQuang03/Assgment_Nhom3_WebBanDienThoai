...
namespace Assgment_Nhom3_WebBanDienThoai.Controllers
{
    public class ShipController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            //trạng thái = 1 là những sản phẩm trong giỏ hàng chưa thanh toán
            // trạng thái = 2 là những sản phẩm trong giỏ hàng đã thanh toán
            var gioHangct = _context.GioHangChiTiets.Where(c => c.IdTaiKhoan.Equals(nguoiDung.Id) && c.TrangThai == 0).ToList(); // list sản phẩm có trong giỏ hàng
