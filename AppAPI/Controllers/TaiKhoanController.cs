...
namespace AppAPI.Controllers
{
    ...
    public class TaiKhoanController : ControllerBase
    {
        ...
        public bool CreateTaiKhoan(string tendn, string matkhau, string hoten,string email,string sdt,string diachi,string anh,int trangthai,Guid idcv)
        {
        ...
        public bool UpdateTaiKhoan(string tendn, string matkhau, string hoten, string email, string sdt, string diachi, string anh, int trangthai, Guid idcv)
        {
            TaiKhoan tk = new TaiKhoan()
            {
                Id = Guid.NewGuid(),
